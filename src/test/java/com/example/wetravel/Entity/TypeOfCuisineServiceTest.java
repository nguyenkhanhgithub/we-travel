...
class TypeOfCuisineServiceTest {
    /**
     * Methods under test:
     *
     * <ul>
     *   <li>{@link TypeOfCuisineService#TypeOfCuisineService()}
     *   <li>{@link TypeOfCuisineService#setRestaurantId(Restaurant)}
     *   <li>{@link TypeOfCuisineService#setTypeCuisineId(TypeOfCuisine)}
     *   <li>{@link TypeOfCuisineService#setTypeCuisineServiceId(Long)}
     *   <li>{@link TypeOfCuisineService#getRestaurantId()}
     *   <li>{@link TypeOfCuisineService#getTypeCuisineId()}
     *   <li>{@link TypeOfCuisineService#getTypeCuisineServiceId()}
     * </ul>
     */
    @Test
    void testConstructor() {
        TypeOfCuisineService actualTypeOfCuisineService = new TypeOfCuisineService();
        ...
        restaurant1.setServiceId(service3);
        ...
        actualTypeOfCuisineService.setRestaurantId(restaurant1);
        TypeOfCuisine typeOfCuisine = new TypeOfCuisine();
        typeOfCuisine.setCuisineName("Cuisine Name");
        typeOfCuisine.setTypeCuisineId(123L);
        typeOfCuisine.setTypeOfCuisineServiceList(new ArrayList<>());
        actualTypeOfCuisineService.setTypeCuisineId(typeOfCuisine);
        actualTypeOfCuisineService.setTypeCuisineServiceId(123L);
        assertSame(restaurant1, actualTypeOfCuisineService.getRestaurantId());
        assertSame(typeOfCuisine, actualTypeOfCuisineService.getTypeCuisineId());
        assertEquals(123L, actualTypeOfCuisineService.getTypeCuisineServiceId().longValue());
    }
     ...
     *
     * <ul>
     *   <li>{@link TypeOfCuisineService#TypeOfCuisineService(Long, Restaurant, TypeOfCuisine)}
     *   <li>{@link TypeOfCuisineService#setRestaurantId(Restaurant)}
     *   <li>{@link TypeOfCuisineService#setTypeCuisineId(TypeOfCuisine)}
     *   <li>{@link TypeOfCuisineService#setTypeCuisineServiceId(Long)}
     *   <li>{@link TypeOfCuisineService#getRestaurantId()}
    ...
    void testConstructor2() {
        ...
        typeOfCuisine.setTypeCuisineId(123L);
        typeOfCuisine.setTypeOfCuisineServiceList(new ArrayList<>());
        TypeOfCuisineService actualTypeOfCuisineService = new TypeOfCuisineService(123L, restaurant1, typeOfCuisine);
        ...
        restaurant2.setServiceId(service6);
        ...
        service7.setRestaurant(restaurant2);
        ...
        restaurant3.setServiceId(service7);
        ...
        actualTypeOfCuisineService.setRestaurantId(restaurant3);
        TypeOfCuisine typeOfCuisine1 = new TypeOfCuisine();
        typeOfCuisine1.setCuisineName("Cuisine Name");
        typeOfCuisine1.setTypeCuisineId(123L);
        typeOfCuisine1.setTypeOfCuisineServiceList(new ArrayList<>());
        actualTypeOfCuisineService.setTypeCuisineId(typeOfCuisine1);
        actualTypeOfCuisineService.setTypeCuisineServiceId(123L);
        assertSame(restaurant3, actualTypeOfCuisineService.getRestaurantId());
        assertSame(typeOfCuisine1, actualTypeOfCuisineService.getTypeCuisineId());
        assertEquals(123L, actualTypeOfCuisineService.getTypeCuisineServiceId().longValue());
    }
}
