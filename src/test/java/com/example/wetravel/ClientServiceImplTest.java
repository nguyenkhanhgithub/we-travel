...
class ClientServiceImplTest {
    ...
    void testLogin() throws HandlerException {
        ...
        account.setAlertList(new ArrayList<>());
        ...
        account.setPostList(new ArrayList<>());
        account.setReportFeedbackList(new ArrayList<>());
        account.setReportPostList(new ArrayList<>());
        ...
        account1.setAlertList(new ArrayList<>());
        ...
        account1.setPostList(new ArrayList<>());
        account1.setReportFeedbackList(new ArrayList<>());
        account1.setReportPostList(new ArrayList<>());
        ...
        account2.setAlertList(new ArrayList<>());
        ...
        account2.setPostList(new ArrayList<>());
        account2.setReportFeedbackList(new ArrayList<>());
        account2.setReportPostList(new ArrayList<>());
        ...
        account3.setAlertList(new ArrayList<>());
        ...
        account3.setPostList(new ArrayList<>());
        account3.setReportFeedbackList(new ArrayList<>());
        account3.setReportPostList(new ArrayList<>());
        ...
        account4.setAlertList(new ArrayList<>());
        ...
        account4.setPostList(new ArrayList<>());
        account4.setReportFeedbackList(new ArrayList<>());
        account4.setReportPostList(new ArrayList<>());
        ...
        account5.setAlertList(new ArrayList<>());
        ...
        account5.setPostList(new ArrayList<>());
        account5.setReportFeedbackList(new ArrayList<>());
        account5.setReportPostList(new ArrayList<>());
        ...
        account6.setAlertList(new ArrayList<>());
        ...
        account6.setPostList(new ArrayList<>());
        account6.setReportFeedbackList(new ArrayList<>());
        account6.setReportPostList(new ArrayList<>());
        ...
        account7.setAlertList(new ArrayList<>());
        ...
        account7.setPostList(new ArrayList<>());
        account7.setReportFeedbackList(new ArrayList<>());
        account7.setReportPostList(new ArrayList<>());
     ...
     */
    @Test
    void testCreateMailForgotPassword2() throws HandlerException {
        assertThrows(HandlerException.class, () -> clientServiceImpl.createMailForgotPassword("jane.doe@example.org"));
    }
     ...
     */
    @Test
    void testCreateMailForgotPassword3() throws HandlerException {
        assertThrows(HandlerException.class, () -> clientServiceImpl.createMailForgotPassword("l.UlUlUlUlUl.U"));
    }
    ...
    void testForgotPassword() throws HandlerException {
        ...
        //       at com.example.wetravel.Security.JwtUtil.extractAllClaims(JwtUtil.java:31)
        //       at com.example.wetravel.Service.ServiceImpl.ClientServiceImpl.forgotPassword(ClientServiceImpl.java:133)
